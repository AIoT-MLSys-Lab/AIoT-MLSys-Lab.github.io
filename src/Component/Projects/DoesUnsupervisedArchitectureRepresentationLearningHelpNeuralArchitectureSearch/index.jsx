...
function DoesUnsupervisedArchitectureRepresentationLearningHelpNeuralArchitectureSearch() {
  return (
    <div className='project_container'>
        ...
        <div className='project_buttons'>
            <a href="https://arxiv.org/pdf/2006.06936.pdf" className='project_button'>
            ...
            <a href="https://mi-zhang.github.io/papers/2020_NeurIPS_arch2vec.bib" className='project_button'>
            ...
            <a href="https://github.com/MSU-MLSys-Lab/arch2vec" className='project_button'>
...
export default DoesUnsupervisedArchitectureRepresentationLearningHelpNeuralArchitectureSearch