  ...
  return (
    <div className='project_container'>
        ...
        <div className='project_buttons'>
            ...
            <PopModal inproceeding = {`@inproceedings{arch2vec2020neurips,`}
                title = {`title={{Does Unsupervised Architecture Representation Learning Help Neural Architecture Search?}},`}
                author = {`author={Yan, Shen and Zheng, Yu and Ao, Wei and Zeng, Xiao and Zhang, Mi},`}
            ...
            <a href="https://mi-zhang.github.io/papers/2020_NeurIPS_arch2vec_poster.pdf" className='project_button'>
        ...
        <div className='project_collection'>
            <div>
                <img src="./images/projects/arch2ve_in.svg" alt=""  className='project_collection_img'/>
            </div>
        </div>
