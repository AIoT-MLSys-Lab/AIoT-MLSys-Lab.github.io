  ...
  return (
    <div className='project_container'>
        ...
        <div className='project_buttons'>
            ...
            <PopModal inproceeding = {`@inproceedings{distream2020sensys,`}
                title = {`title={{Distream: Scaling Live Video Analytics with Workload-Adaptive Distributed Edge Intelligence}},`}
                author = {`author={Zeng, Xiao and Fang, Biyi and Shen, Haichen and Zhang, Mi},`}
        ...
        <div className='project_collection'>
            <div>
                <img src="./images/projects/Distream_in.svg" alt="" />
            </div>
        </div>
